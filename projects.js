       ...
       <div class="about-project flex">
          ...
          <div class="project-info">
             <ul class="flex">
                ...
                <li class="counter"></li>
                <li class="role">${project.info.position}</li>
                <li class="counter"></li>
    ...
    projects.map((project) => {
       if(id == project.id){
          ...
          <div class="modal-body" id="modal-body">
             ...
             <div class="project-description col-xl-8" id="description">
                <p>${project.description}</p>
             </div>
             <div class="tags col-xl-4">
             ...
             <div class="footer flex" id="footer">
                <div class="btn-container">
                   <button type="submit" class="view-btn" onclick="location.href = '${project.liveLink}'">
                      <span>See Live</span>
                      <span><i class="bi bi-box-arrow-up-right"></i></span>
                   </button>
                   <button type="submit" class="view-btn" onclick="location.href = '${project.sourceLink}'">
                      <span>Source</span>
